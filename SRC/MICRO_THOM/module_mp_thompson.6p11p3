...
!..Initialize various constants for computing radar reflectivity.
      ...
      if (.not. iiwarm) then
        ...
        INQUIRE(FILE='./RUNDATA/thompson_lookup_tables_r1.bin', & ! rename as _r1 to avoid confusion w/old files.
        ...
        if(read_lookup_tables_from_file) then
          ...
          OPEN(UNIT=92,FILE='./RUNDATA/thompson_lookup_tables_r1.bin', &
               FORM='unformatted')
